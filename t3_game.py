...
"""
The beginning board state; 
    can be customized for debugging or playing on non-standard boards like a 4x4 battlefield extreme.
    Beware though, that the AI will take a long time to think on larger board states
"""
START_STATE = [
    [0, 0, 0],
    [0, 0, 0],
